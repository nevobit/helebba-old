            ...
            <Page size="A4" style={styles.page}>
                ...
                >
                    ...
                    >
                        ...
                        >
                            {DivisaFormater({ value: spec.price || 0, country: account?.country })}
                        </Text>
                        <Text
                            style={{
                                fontSize: 9,
                        ...
                        >
                            {DivisaFormater({ value: spec.price || 0 * (spec.amount ?? 0), country: account?.country })}
                        </Text>
                    </View>
                    ))}
                ...
                <Text style={{
                    ...
                    borderRadius: 3,
                    fontFamily: 'Helvetica-Bold'
                }}>Total:  {DivisaFormater({value: specs?.reduce((a: number, c: Partial<ProductDocument>) => a + c.price! * c.amount!, 0) || 0, country: account?.country })}</Text>
                </View>                              
