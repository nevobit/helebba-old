...
import { Funnel, FunnelSchemaMongo, Result, StatusType } from "@helebba/entities";
...
export const getAllFunnels = async ( {page = 1, limit = 14, search= '', account}: Params): Promise<Result<Funnel>> => {
