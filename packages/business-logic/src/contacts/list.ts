...
import { Contact, ContactSchemaMongo, Result, StatusType } from "@helebba/entities";
...
export const getAllContacts = async ( {page = 1, limit = 14, search= '', account}: Params): Promise<Result<Contact>> => {
