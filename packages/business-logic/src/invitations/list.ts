...
import { Developer, DeveloperSchemaMongo, Result, StatusType } from "@helebba/entities";
...
export const getAllInvitations = async ( {page = 1, limit = 14, search= '', account}: Params): Promise<Result<Developer>> => {
