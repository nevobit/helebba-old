...
import { Result, Service, ServiceSchemaMongo, StatusType } from "@helebba/entities";
...
export const getAllServices = async ({ page = 1, limit = 14, search = '', account }: Params): Promise<Result<Service>> => {
