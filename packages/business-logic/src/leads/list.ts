...
import { Lead, LeadSchemaMongo, Result, StatusType } from "@helebba/entities";
...
export const getAllLeads = async ( {page = 1, limit = 14, search= '', account}: Params): Promise<Result<Lead>> => {
