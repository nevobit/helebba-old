...
import { Employee, EmployeeSchemaMongo, Result, StatusType } from "@helebba/entities";
...
export const getAllEmployees = async ( {page = 1, limit = 14, search= '', account}: Params): Promise<Result<Employee>> => {
