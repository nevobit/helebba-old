...
import { Register, RegisterSchemaMongo, Result, StatusType } from "@helebba/entities";
...
export const getAllRegisters = async ( {page = 1, limit = 14, search= '', account}: Params): Promise<Result<Register>> => {
